...
export default function Testimonial() {
  ...
  return (
    <div id="testimonial">
      <div
        className="max-h-[450px] py-12 lg:px-12 md:px-5 px-3 bg-gradient-portfolio w-full dark:bg-gradient-portfolio-dark"
        // style={{
      ...
      >
        <div className="lg:container mx-auto px-0 sm:max-h-[350px]">
          <div className="text-center">
            ...
            <p
              className={`max-w-2xl font-[200] font-recoletaBold mx-auto mb-12 lg:mb-24 dark:text-[#EAF7FC]`}
            >
          ...
          <Slider {...settings} className="cursor-all-scroll">
            <div className="flex pl-0">
              <div className="w-[100%] sm:w-[95%] pl-20 m-auto rounded-2xl p-4 lg:p-6 min-h-[250px] bg-gradient-testimonial dark:bg-gradient-testimonial-dark">
                <div className="flex">
                  ...
                  <div className="flex flex-col gap-x-4 md:flex-col">
                    <div className="font-medium text-base dark:text-[#47626D]">Daisy Papo</div>
                    <div
                    ...
                    <p
                      className={`mb-6 font-[200] font-recoletaBlack min-h-[70px] text-[15px] mt-3 dark:text-[#EAF7FC]`}
                    >
