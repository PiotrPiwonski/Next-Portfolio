    ...
    <React.Fragment>
      <div className="relative">
        <div
          ...
          } cursor-pointer fixed w-16 h-16 lg:w-24 lg:h-24 bg-[#48AFDE] flex justify-center items-center rounded-br-3xl`}
        >
          <div
            onClick={() => setIsOpen(false)}
            className="relative w-7 lg:w-10 h-7 lg:h-10 justify-center items-center"
          >
            {isOpen ? (
              <svg
        ...
        <div className="relative">
          <div className="z-20 absolute transform-gpu ease-in-out duration-500 transition-all scale-100 -translate-x-none -translate-y-none opacity-100 bg-[#223740] bg-opacity-95 w-full h-screen flex flex-col sm:flex-row lg:flex-col items-center justify-center">
            ...
            <section className="mt-14 sm:mt-12 lg:mt-14 text-center relative sm:absolute lg:relative sm:right-0 lg:right-0 h-auto sm:h-full lg:h-auto">
              <h3 className="block sm:hidden lg:block font-bold text-[#48AFDE] text-2xl uppercas mb-5">
                Follow Me Around
              </h3>
              <div className="flex flex-row sm:flex-col sm:mt-20 sm:mr-5 lg:flex-row">
                <a
                  href=""
                ...
                <a
                  href="https://github.com/PiotrPiwonski"
                  className="text-gray-300 hover:text-white transition-color duration-300"
                >
                  <svg
                    stroke="currentColor"
                ...
                <a
                  href="https://www.linkedin.com/in/piotr-piwo%C5%84ski-a85332256/"
                  className="text-gray-300 hover:text-white transition-color duration-300"
                >
                  <svg
                    stroke="currentColor"
