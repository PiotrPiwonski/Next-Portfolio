  ...
  return (
    <React.Fragment>
      <div className="relative">
        <div className="overlaydark h-[400px] lg:top-[0px] sm:top-0 z-20 border-t border-gray-300"></div>
        <img
          src={data?.images[0]}
          alt="bg photo"
      ...
      <div className="absolute z-30 top-[42px] sm:top-[200px] sm:left-[65px] justify-center items-center w-full px-10 sm:w-3/4 xl:w-1/2 sm:px-0 sm:text-left">
        <div className="container m-auto">
          <div className="max-w-[650px] w-[100%] m-auto">
            <p className="opacity-3 sm:text-left text-center font-sans text-[#f3fcff] mb-3">
              Project Sample
            </p>
            <h1 className="opacity-3 text-[#000000] sm:text-left text-center w-full sm:w-3/4 font-recoletaBold text-4xl md:text-4xl lg:text-4xl xl:text-4xl">
              {data?.title}
            </h1>
          </div>
        </div>
      </div>
      <div className="grid grid-cols-12 relative space-x-0 lg:space-x-8 bg-gradient-portfolio-detail dark:bg-gradient-portfolio-detail-dark">
        ...
        <div className="col-span-12 lg:col-span-4 lg:px-0 sm:px-20">
          <div className="mt-10 sm:mt-24 w-full lg:max-w-[300px] lg:px-1 px-3 sticky top-36 pb-14">
            ...
            <p className="text-[14px] font-sans mb-4 text-[#223740] dark:text-gray-400">
              {data?.des}
            </p>
            <p id="highlight" className="my-2 text-dark text-[20px] font-sans dark:text-white">
